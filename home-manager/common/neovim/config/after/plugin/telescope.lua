...
-- Neovim helpers
vim.keymap.set("n", "<leader>fnc", builtin.commands, { desc = "Telescope commands" })
vim.keymap.set("n", "<leader>fhl", builtin.highlights, { desc = "Telescope highlights" })
vim.keymap.set("n", "<leader>fkm", builtin.keymaps, { desc = "Telescope keymaps" })
