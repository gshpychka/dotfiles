...
{
  options.my.gaming = {
    enable = lib.mkEnableOption "gaming features (Jovian Steam Gaming Mode, gaming hardware)";
  };
  ...
  config = lib.mkIf cfg.enable {
    ...
    sops.secrets.jovian-hashed-password.neededForUsers = true;
    ...
    # this is already set by jovian-nixos
